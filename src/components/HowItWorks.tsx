...
const steps = [
  {
    ...
    description:
      "Enter your topic and subtopics. Our AI understands your learning goals and creates a structured curriculum tailored to your needs.",
  ...
  },
  {
    ...
    description:
      "Choose your preferred format and watch our AI create comprehensive courses with theory, visuals, and interactive elements.",
    features: [
      "Text & Image courses",
      "Video & Theory courses",
      "Interactive quizzes",
    ],
  ...
  },
  {
    ...
    description:
      "Generate courses in 23+ languages with AI-powered translation, making learning accessible to a global audience.",
  ...
  },
  {
    ...
    title: "Launch & Learn",
    description:
      "Your course is ready! Study online, download for offline access, or install as a PWA for the ultimate learning experience.",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 md:mb-20">
          ...
          <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto">
            Our AI-powered platform transforms your learning goals into
            comprehensive, interactive courses with just a few clicks.
          </p>
        </div>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="lg:w-1/2 flex justify-center relative mt-8 lg:mt-0">
                  ...
                  <div className="hidden lg:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 h-12 w-12 rounded-full bg-background border-4 border-primary items-center justify-center shadow-lg">
                    <span className="font-display font-bold text-primary text-sm relative z-10">
                      {index + 1}
                    </span>
                  </div>
