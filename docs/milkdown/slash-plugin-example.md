...
1.
SlashProvider – Measures the caret position and manages show / hide of your menu.

2.
slashFactory(id) – Generates a ctx slice & ProseMirror plugin pair that plugs the provider into the editor.
...
1.
A <SlashMenu/> React component renders the list.

2.
The component root is passed to SlashProvider (just like the tooltip demo).

3.
React hooks manage internal focus & keyboard navigation.
